...
#define HSPAWN_TIMER_RATE 500 // После, как долго будет таймер Визова появляются в будинку функции? (в мс)
...
#define MAX_HOUSES_OWNED 1 // Макс будинкiв, принадлежащих за игрока
...
#define HOUSE_SELLING_PROCENT2 2.2 // OFC Общий процент близлежащих будинкiв будет идти /down путем, когда дом продается /bought неподалеку.
...
{
timcontrol = SetTimer("HouseOneSec", 1009, 1);//контрольный таймер нахождения игрока в будинку
